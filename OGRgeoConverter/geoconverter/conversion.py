...
def convert_files(
    ...
    if len(input_files) > 0:
        ...
        input_format_info = OgrFormat.get_format_information_by_name(
            input_format_name)
        output_format_info = OgrFormat.get_format_information_by_name(
            output_format_name)
        ...
        output_file_path = _get_extended_output_file_path(
            destination_path,
            base_name,
            output_format_info)
        ...
        _add_ogr_log_entry(
            ...
            file_list,
            destination_path,
            ogr2ogr_converter.get_last_command(),
            ogr2ogr_converter.get_last_output(),

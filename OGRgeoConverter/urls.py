...
urlpatterns = patterns('',
    ...
    url(r'^download/' + jobidentification.get_job_id_regex(), 'OGRgeoConverter.views.download_output_file'),
    url(r'^remove/queue-' + jobidentification.get_job_id_regex(), 'OGRgeoConverter.views.remove_download_item'),

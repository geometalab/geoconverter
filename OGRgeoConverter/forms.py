...
class GeoConverterFilesForm(forms.Form):
    ...
    files_ogrformat = forms.ChoiceField(widget=forms.Select, label='Export format')
...
class GeoConverterWebservicesForm(forms.Form):
    ...
    webservices_ogrformat = forms.ChoiceField(widget=forms.Select, label='Export format')

...
//////////////////////////////////////////////////////////////////////
    ...
    getStoredFilesIDs: function(){
        return this._storedFileIds;
    },
    getFilenameByID: function(fileID){
       return this._handler.getName(fileID);
    },
...
//    },
    ...
    _formatFileName: function(name){
    	var weightedLength = getWeightedStringLength(name);
    	
        if (weightedLength > 65){
        	name = getSplittedString(name, 35, '...', 25);
        }
        return name;
    },
...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
            ...
            (!this._options.button ? '<div class="qq-upload-button default-border"><div>{uploadButtonText}</div></div>' : '') +
...
function getWeightedStringLength(name) {
	var weightedLength = 0.0;
	
	for ( var i = 0; i < name.length; i++ )
	{
		weightedLength += getCharacterWidth(name.charAt(i));
	}
	
	return weightedLength;
}

function getSplittedString(name, length1, splitter, length2) {
	var part1 = '';
	var part2 = '';
	var currentLength = 0;
	var position1 = 0;
	...
	for (position1 = 0; position1 < name.toString().length; position1++ )
	{
		currentLength += getCharacterWidth(name.charAt(position1));
		if (currentLength <= length1) {
			part1 += name.charAt(position1);
		} else {
			break;
		}
	}
	...
	currentLength = 0;
	for (position2 = name.toString().length - 1; position2 > position1; position2-- )
	{
		currentLength += getCharacterWidth(name.charAt(position2));
		if (currentLength <= length2) {
			part2 = name.charAt(position2) + part2;
		} else {
			break;
		}
	}
	
	if (part1.length < name.toString().length) {
...
function getCharacterWidth(character) {
	...
	if (character == "f") return 1.5;
	if (character == "g") return 2;
	if (character == "h") return 2;
	if (character == "i") return 1;
	if (character == "j") return 1.5;
	if (character == "k") return 2;
	if (character == "l") return 1;
	if (character == "m") return 3;
	if (character == "n") return 2;
	if (character == "o") return 2;
	if (character == "p") return 2;
	if (character == "q") return 2;
	if (character == "r") return 2;
	if (character == "s") return 2;
	if (character == "t") return 1.5;
	if (character == "u") return 2;
	if (character == "v") return 2;
	if (character == "w") return 3;
	if (character == "x") return 2;
	if (character == "y") return 2;
	if (character == "z") return 2;
	if (character == "A") return 2.5;
	if (character == "B") return 2.5;
	if (character == "C") return 2.5;
	if (character == "D") return 2.5;
	if (character == "E") return 2;
	if (character == "F") return 2;
	if (character == "G") return 2.5;
	if (character == "H") return 2.5;
	if (character == "I") return 1.5;
	if (character == "J") return 1.5;
	if (character == "K") return 2.5;
	if (character == "L") return 2.5;
	if (character == "M") return 3;
	if (character == "N") return 2.5;
	if (character == "O") return 2.5;
	if (character == "P") return 2;
	if (character == "Q") return 3;
	if (character == "R") return 2.5;
	if (character == "S") return 2.5;
	if (character == "T") return 2.5;
	if (character == "U") return 2.5;
	if (character == "V") return 2.5;
	if (character == "W") return 3.5;
	if (character == "X") return 2.5;
	if (character == "Y") return 2.5;
	if (character == "Z") return 2.5;
	if (character == "0") return 2.5;
	if (character == "1") return 2.5;
	if (character == "2") return 2.5;
	if (character == "3") return 2.5;
	if (character == "4") return 2.5;
	if (character == "5") return 2.5;
	if (character == "6") return 2.5;
	if (character == "7") return 2.5;
	if (character == "8") return 2.5;
	if (character == "9") return 2.5;
	if (character == " ") return 1.5;
	if (character == ".") return 1;
	if (character == ",") return 1;
	if (character == "_") return 2.5;
	if (character == "-") return 1.5;
	return 3;
}
